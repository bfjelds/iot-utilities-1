...
namespace DeviceCenter
{
    ...
    public class AppInformation
    {
        ...
        public static string InternetRadio_PackageFullName_x86 = "InternetRadioHeaded_1.0.3.0_x86__s9y1p3hwd5qda";
        public static string InternetRadio_PackageFullName_arm = "InternetRadioHeaded_1.0.3.0_arm__s9y1p3hwd5qda";
                    ...
                    {
                        {
                            "x86", new ApplicationFiles()
                            {
                                AppX = MakePath("InternetRadio\\x86\\InternetRadioHeaded_1.0.3.0_x86.appx"),
                                PackageFullName = InternetRadio_PackageFullName_x86, 
                                Certificate = MakePath("InternetRadio\\X86\\InternetRadioHeaded_1.0.3.0_x86.cer"),
                                Dependencies = new List<FileInfo>()
                                {
                        ...
                        },
                        {
                            "ARM", new ApplicationFiles()
                            {
                                AppX = MakePath("InternetRadio\\ARM\\InternetRadioHeaded_1.0.3.0_ARM.appx"),
                                PackageFullName = InternetRadio_PackageFullName_arm,
                                Certificate = MakePath("InternetRadio\\ARM\\InternetRadioHeaded_1.0.3.0_ARM.cer"),
                                Dependencies = new List<FileInfo>()
                                {
