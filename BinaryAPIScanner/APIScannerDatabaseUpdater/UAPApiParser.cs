...
namespace APIScannerDatabaseUpdater
{
    ...
    public class UapApiParser
    {
        ...
        public static void GenerateCrtDatabase(string pathToDllDirectory)
        {
            ...
            string crtBinariesFilename = @"C:\Users\t-jdeck\Development\MS-IOT\athens-utilities\BinaryAPIScanner\BinaryAPIScanner\APIs\crt_dlls.txt";
            string[] crtDlls = File.ReadAllLines(crtBinariesFilename);
        ...
        public static void GenerateOrdinalMap()
        {
            ...
            string dllListFilename = @"C:\Users\t-jdeck\Development\MS-IOT\athens-utilities\BinaryAPIScanner\BinaryAPIScanner\APIs\ordinalmap_dlls.txt";
            string[] dllList = File.ReadAllLines(dllListFilename);
